...
\title{Увод в програмирането 2020/2021\\ Група 8, практикум №3 и №4}
\date{}
...
\exercise{1}{
    Да се напише програма, която приема цяло положително число и извежда цифрите му наобратно.
}
\bigskip

\exercise{2}{
    Да се напише програма, която чете цели положителни числа от конзолата докато не се въведе \code{0}.
    Тогава от въведените числа (без 0) да се изведат следните:
    \begin{itemize}
...
\exercise{9}{
    ...
    \begin{itemize}
        ...
        \item Числото, получено от обръщането на всички нули в единици и обратно
    \end{itemize}
}
\example{4}{
    ...
    \outputline{Complement: 3}
}
\explanation{4 $\equiv$ $100_2$. 4 е степен на двойката и има две поредни нули.
При обръщане на битовете получаваме $011_2 \equiv 3$.}
...
\example{10}{
    ...
    \outputline{Complement: 5}
}
\explanation{10 $\equiv 1010_2$, имаме алтерниращи битове. При обръщане получаваме $0101_2 \equiv 5$.}
\bigskip

\exercise{10*}{
    Да се напише програма, която при подадено цяло число изписва всички
    негови прости делители.
}
\bigskip
